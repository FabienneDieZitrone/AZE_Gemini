...
try {
    ...
    // DEAKTIVIERT - users Tabelle hat keine created_at Spalte
    ...
    if ($user_data) {
        ...
        $insert_user_stmt = $conn->prepare("INSERT INTO users (username, display_name, role, azure_oid) VALUES (?, ?, 'Honorarkraft', ?)");
