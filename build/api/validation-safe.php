<?php
/**
 * Input Validation Library - SAFE VERSION
 * This version removes htmlspecialchars from input sanitization
 * to prevent 500 errors with special characters
 * 
 * IMPORTANT: Output must be escaped when displayed!
 */
...
class InputValidator {
     ...
     * Removes dangerous characters without breaking UTF-8 or special chars
    ...
    public static function sanitizeString($input) {
        ...
        // IMPORTANT: Do NOT use htmlspecialchars here!
        // It should be applied at output time, not input time
        // This prevents 500 errors with special characters
...
// MIGRATION NOTICE:
// This is the safe version of validation.php that doesn't use htmlspecialchars
// on input. To use this version:
// 1. Backup current validation.php: mv validation.php validation.backup.php
// 2. Rename this file: mv validation-safe.php validation.php
// 3. Test thoroughly with special characters
// 4. Remember to escape output when displaying: InputValidator::escapeHtml($data)