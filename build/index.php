...
<html lang="de">
  <head>
    ...
    <script type="module" crossorigin src="/assets/index-BjBgGIkt.js?v=<?php echo $cacheBuster; ?>"></script>
    <link rel="stylesheet" crossorigin href="/assets/index-P1c-qG7k.css?v=<?php echo $cacheBuster; ?>">
  </head>
  <body>
    <div id="root"></div>
  </body>
